...
<?php if(isset($employer) && $employer > 0): ?>
<div class="updated fade below-h2" style="background-color: rgb(255, 251, 204);">
    <p>
        <?php _e("You are browsing jobs posted by company", "wpjobboard") ?>&nbsp;
        <strong><?php echo (strlen($company->company_name)>1) ? esc_html($company->company_name) : '-' ?> (ID: <?php echo $company->getId() ?>)</strong>.
...
<ul class="subsubsub">
    <li><a <?php if($filter == "all"): ?>class="current"<?php endif; ?> href="<?php esc_attr_e(wpjb_admin_url("job", "index", null)) ?>"><?php _e("All", "wpjobboard") ?></a><span class="count">(<?php echo (int)$stat->all ?>)</span> | </li>
    <li><a <?php if($filter == "active"): ?>class="current"<?php endif; ?>href="<?php esc_attr_e(wpjb_admin_url("job", "index", null, array("filter"=>"active"))) ?>"><?php _e("Active", "wpjobboard") ?></a><span class="count">(<?php echo (int)$stat->active ?>)</span> | </li>
    <li><a <?php if($filter == "unread"): ?>class="current"<?php endif; ?>href="<?php esc_attr_e(wpjb_admin_url("job", "index", null, array("filter"=>"unread"))) ?>"><?php _e("Unread", "wpjobboard") ?></a><span class="count">(<?php echo (int)$stat->unread ?>)</span> | </li>
    <li><a <?php if($filter == "awaiting"): ?>class="current"<?php endif; ?>href="<?php esc_attr_e(wpjb_admin_url("job", "index", null, array("filter"=>"awaiting"))) ?>"><?php _e("Awaiting Approval", "wpjobboard") ?></a><span class="count">(<?php echo (int)$stat->awaiting ?>)</span> | </li>
    <li><a <?php if($filter == "inactive"): ?>class="current"<?php endif; ?>href="<?php esc_attr_e(wpjb_admin_url("job", "index", null, array("filter"=>"inactive"))) ?>"><?php _e("Inactive", "wpjobboard") ?></a><span class="count">(<?php echo (int)$stat->inactive ?>)</span> | </li>
    <li><a <?php if($filter == "expiring"): ?>class="current"<?php endif; ?>href="<?php esc_attr_e(wpjb_admin_url("job", "index", null, array("filter"=>"expiring"))) ?>"><?php _e("Expiring Soon", "wpjobboard") ?></a><span class="count">(<?php echo (int)$stat->expiring ?>)</span> | </li>
    <li><a <?php if($filter == "expiried"): ?>class="current"<?php endif; ?>href="<?php esc_attr_e(wpjb_admin_url("job", "index", null, array("filter"=>"expired"))) ?>"><?php _e("Expired", "wpjobboard") ?></a><span class="count">(<?php echo (int)$stat->expired ?>)</span> </li>
        ...
        <tr valign="top" class="<?php if($i%2==0): ?>alternate <?php endif; ?> author-self status-publish iedit <?php if($item->requiresAdminAction()): ?>wpjb-unread<?php endif; ?>">
            ...
            <td class="post-title column-title">
                ...
                <div class="row-actions">
                    ...
                    <span><a title="<?php _e("Applicants", "wpjobboard") ?>" href="<?php esc_attr_e(wpjb_admin_url("application", "index", null, array("job"=>$item->id))) ?>"><?php _e("Applicants", "wpjobboard") ?></a> <span style="color:#666">(<?php echo $item->applications ?>)</span> | </span>
            ...
            <td>
                <a href="<?php esc_attr_e(wpjb_admin_url("application", "index", null, array("job"=>$item->id))) ?>">
                    <?php echo $item->applications ?> 
                </a>
                
                <?php if($item->newApplications() > 0): ?>
                <a href="<?php esc_attr_e(wpjb_admin_url("application", "index", null, array("job"=>$item->id, "filter"=>"new"))) ?>">
