...
class Wpjb_Utility_Yoast {
    ...
    public static function connect() 
    {
        ...
        add_filter("wpseo_canonical", array($self, "url"));
        add_filter("wpseo_title", array($self, "title"));  
        add_filter("get_the_date", array($self, "date"), 10, 2);
        add_filter("get_the_modified_date", array($self, "modifiedDate"), 10, 2);
        
        add_action("wpseo_opengraph", array($self, "image"));
    }
