...
function wpjb_date($date, $format = null) {
    ...
    $date->modify(get_option("gmt_offset")." hours");
...
function wpjb_form_field_upload(Daq_Form_Element $e, $form = null) {
    ...
    <div class="wpjb-upload-actions">
        ...
        <a href="#<?php echo $limit ?>" id="wpjb-upload-<?php echo $e->getName() ?>" class="button">
            <img style="vertical-align:middle" src="<?php esc_attr_e(plugins_url()."/wpjobboard/public/images/12-em-plus.png") ?>" alt="" />
            <span class="wpjb-upload-empty"><?php _e("upload file ...", "wpjobboard") ?></span>
            
        </a>
        
        <span id="wpjb-upload-limit-<?php echo $e->getName() ?>" style="opacity:0.5">
            <span class="limit-reached"><?php _e("Limit reached, delete at least one file above to add more.", "wpjobboard") ?></span>
