        ...
        <table class="form-table">
            ...
            <?php if(in_array($field->getName(), $exclude_fields)) continue; ?>
                ...
                <td>
                    ...
                    <?php $base = wpjb_upload_dir("resume", $field->getName(), $form->getId()) ?>
                    <?php foreach(wpjb_glob($base["basedir"]."/[!_]*") as $file): ?>
                        <img src="<?php echo $base["baseurl"]."/".basename($file) ?>" alt="" style="max-width:128px; max-height:128px" />
                    <?php endforeach; ?>
                    <?php else: ?>
