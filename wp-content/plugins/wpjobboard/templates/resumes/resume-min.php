    ...
    <table class="wpjb-info">
        <tbody>
            <tr>
                ...
                <td><?php wpjb_date_display('d, l Y', $resume) ?></td>
            </tr>
            ...
            <tr>
                <td><?php _e("Degree", "wpjobboard") ?></td>
            ...
            <tr>
                <td><?php _e("Experience", "wpjobboard") ?></td>
            ...
            <tr>
                <td><?php _e("Category", "wpjobboard") ?></td>
