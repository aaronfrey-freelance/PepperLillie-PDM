    ...
    WpjbXHR = $.ajax({
        ...
        success: function(response) {
            ...
            if(total == 0) {
                ...
                $("#wpjb-job-list tbody").html('<tr><td colspan="3">'+WpjbData.no_jobs_found+'</td></tr>');
                return;
            }
            ...
            $("#wpjb-job-list tbody tr.wpjb-ls-load-more").remove();
            $("#wpjb-job-list").css("opacity", "1");
            $("#wpjb-job-list tbody").append(response.html);
                                
            loaded = $("#wpjb-job-list tbody tr").length;
            ...
            if(more) {
                ...
                $("#wpjb-job-list tbody").append('<tr class="wpjb-ls-load-more"><td colspan="3"><a href="#" data-wpjb-page="'+(nextPage)+'" class="wpjb-button btn">'+txt+'</a></td></tr>');
