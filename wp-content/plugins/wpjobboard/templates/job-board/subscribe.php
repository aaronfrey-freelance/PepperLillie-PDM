...
<div id="wpjb-overlay" class="wpjb-overlay wpjb-subscribe-rss">
     <div>
         <h2>
             <?php _e("Subscribe To Personalized Notifications", "wpjobboard") ?>
             <a href="#" class="wpjb-subscribe-close">&nbsp;</a>
         </h2>
         ...
         <div>
             <strong>
                 <img src="<?php esc_attr_e(wpjb_img("subscribe-email.png")) ?>" alt="" />
         ...
         <div>
             <strong>
                 <img src="<?php esc_attr_e(wpjb_img("subscribe-feed.png")) ?>" alt="" />
